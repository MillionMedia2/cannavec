...
import { TravelPlannerSection } from "@/components/travel-planner-section";
import { Plane } from "lucide-react";

export default async function DashboardTravelPage() {
          ...
          <div className="px-6 pt-8 pb-2">
            <div className="flex items-center gap-3 mb-1">
              <div className="w-8 h-8 bg-[#f5f7f0] rounded-lg flex items-center justify-center">
                <Plane className="w-4 h-4 text-[#8a9a5a]" />
              </div>
              <h1 className="font-display text-2xl text-cannavec-900">Cannabis Travel Planner</h1>
            </div>
            <p className="text-sm text-warm-500 mt-1 ml-11">
              Can you travel with your prescribed cannabis? Enter your origin and destination — get a route assessment, transit hub warnings, required documents, and a step-by-step checklist.
            </p>
          </div>
